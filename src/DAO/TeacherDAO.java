...
public class TeacherDAO {
	...
	public static Teacher login(Teacher bean) throws NoSuchAlgorithmException {
		...
		String searchQuery = "select * from teachers where teacherEmail='" + teacherEmail + "' AND teacherPassword='"
				+ pass + "'";
	...
	public static void add(Teacher bean) throws NoSuchAlgorithmException {
		...
		try {
			...
			ps = currentCon.prepareStatement(
					"insert into teachers (teacherEmail, teacherPassword, teacherName, teacherAddress, teacherPhone, teacherRole)"
							+ " values(?,?,?,?,?,?)");
