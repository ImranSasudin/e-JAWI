					...
					<div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									<form action="/e-JAWI/TeacherController" method="post">
									<input type="hidden" name="id" value="<c:out value="${teacher.id}"/>"/>
										<div class="row mt-3">
											<div class="col-md-12">
												<div class="form-group form-group-default">
													<label>Email</label> <input id="" type="email" required
														class="form-control" name="email" value="<c:out value="${teacher.teacherEmail }"/>" placeholder="">
												</div>
												<div class="form-group form-group-default">
													<label>Name</label> <input id="" type="text" required
														class="form-control" name="name" value="<c:out value="${teacher.teacherName }"/>" placeholder="">
												</div>
												<div class="form-group form-group-default">
													<label>Address</label>
													<textarea id="" class="form-control" name="address"
														placeholder=""><c:out value="${teacher.teacherAddress }"/></textarea>
												</div>
												<div class="form-group form-group-default">
													<label>Phone</label> <input id="" type="number" required
														class="form-control" name="phone" value="<c:out value="${teacher.teacherPhone }"/>" placeholder="">
												</div>
												<div class="form-group form-group-default">
													<label>Role</label> <select id="" class="form-control"
														required name="role">
														<option selected hidden value="<c:out value="${teacher.teacherRole }"/>"><c:out value="${teacher.teacherRole }"/></option>
										...
										<div class="text-right mt-3 mb-3">
											...
											<button class="btn btn-success" name="action" value="UpdateTeacher">Save</button>
										</div>
									</form>
								</div>
							</div>
