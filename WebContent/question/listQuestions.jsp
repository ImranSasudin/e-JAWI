					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Quiz : <c:out value="${quiz.quizName}" escapeXml="false"/></h4>
											...
											<div class="modal-content">
												<form action="QuestionController" method="post">
													<input type="hidden" name="quizId"
														value="<c:out value="${quiz.quizId }"/>" />
													<div class="modal-header no-bd">
														<h5 class="modal-title">
															<span class="fw-mediumbold"> Add</span> <span
																class="fw-light"> Question </span>
														</h5>
														...
														<div class="row">
															<div class="col-sm-12">
																...
																<div class="form-group form-group-default">
																	<label>Number</label> <input id="addName" type="text"
																		class="form-control" name="number" placeholder="">
																</div>
																<div class="form-group form-group-default">
																	<label>Question</label>
																	<textarea id="addName" class="form-control" name="name"
														...
														<div class="row">
															<div class="col-sm-12">
																<table class="table">
																	...
																	<tbody>
																		<tr>
																			<td><input id="addName" type="radio"
																				class="form-control" name="answer" value="1"
																				placeholder="" required></td>
																			<td><input id="addName" type="text"
																				class="form-control" name="option1" placeholder=""
																				required></td>
																		</tr>
																		<tr>
																			<td><input id="addName" type="radio"
																				class="form-control" name="answer" value="2"
																				placeholder=""></td>
																			<td><input id="addName" type="text"
																				class="form-control" name="option2" placeholder=""
																				required></td>
																		</tr>
																		<tr>
																			<td><input id="addName" type="radio"
																				class="form-control" name="answer" value="3"
																				placeholder=""></td>
																			<td><input id="addName" type="text"
																				class="form-control" name="option3" placeholder=""
																				required></td>
																		</tr>
																		<tr>
																			<td><input id="addName" type="radio"
																				class="form-control" name="answer" value="4"
																				placeholder=""></td>
																			<td><input id="addName" type="text"
																				class="form-control" name="option4" placeholder=""
																				required></td>
																		</tr>
																	</tbody>
																</table>
													...
													<div class="modal-footer no-bd">
														<button type="submit" id="addRowButton" name="action"
															value="Add" class="btn btn-primary">Add</button>
														...
														<td>
															<div class="form-button-action">
																<button type="button" class="btn btn-success"
																	...
																	data-content='Option 1 : ${question.option1 }<br>
																	Option 2 : ${question.option2 }<br>
																	Option 3 : ${question.option3 }<br>
																	Option 3 : ${question.option4 }<br>
																	Correct Answer : ${question.answer }<br>'>
																	Answer</button>
																<a
																	href="QuestionController?action=delete&questionId=<c:out value="${question.questionId}" />&quizId=<c:out value="${quiz.quizId}" />"
																	data-toggle="tooltip" title=""
																	onClick="return confirm('Confirm delete?');"
																	class="btn btn-link btn-danger"
																	data-original-title="Delete This Question"> <i
																	class="fa fa-times"></i>
																</a>
															</div>
														</td>
							...
							<div class="text-left mt-3 mb-3">
								<a class="btn btn-primary" href="/e-JAWI/TeacherController?action=listQuiz">Back</a>
							</div>
						</div>
					</div>
				</div>
