					...
					<div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									<form action="/e-JAWI/ParentController" method="post">
									<input type="hidden" name="id" value="<c:out value="${parent.id}"/>"/>
										<div class="row mt-3">
											<div class="col-md-12">
												<div class="form-group form-group-default">
													<label>Email</label> <input id="" type="email" required
														class="form-control" name="email" value="<c:out value="${parent.parentEmail }"/>" placeholder="">
												</div>
												<div class="form-group form-group-default">
													<label>Name</label> <input id="" type="text" required
														class="form-control" name="name" value="<c:out value="${parent.parentName }"/>" placeholder="">
												</div>
												<div class="form-group form-group-default">
													<label>Address</label>
													<textarea id="" class="form-control" name="address"
														placeholder=""><c:out value="${parent.parentAddress }"/></textarea>
												</div>
												<div class="form-group form-group-default">
													<label>Phone</label> <input id="" type="number" required
														class="form-control" name="phone" value="<c:out value="${parent.parentPhone }"/>" placeholder="">
												</div>
											</div>
										</div>
										<div class="text-right mt-3 mb-3">
											<a class="btn btn-primary" href="javascript:history.back()">Back</a>
											<button class="btn btn-success" name="action" value="UpdateParent">Save</button>
										</div>
									</form>
								</div>
							</div>
